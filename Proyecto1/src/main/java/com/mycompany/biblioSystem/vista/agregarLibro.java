...
public class agregarLibro extends javax.swing.JDialog {
    ...
    public agregarLibro(java.awt.Frame parent, boolean modal, SistemaLibros sistema) {
        super(parent, modal);
    ...
    private void confirmButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmButtonActionPerformed
       ...
       sistema.agregarLibro(codigo, ISBN, titulo, autor, genero, anio, disponibles);
       dispose();
       }else{String error = "Error5: codigo o ISBN ya está registrado";
