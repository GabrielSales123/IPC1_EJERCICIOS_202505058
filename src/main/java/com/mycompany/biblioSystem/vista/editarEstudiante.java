...
public class editarEstudiante extends javax.swing.JDialog {
     ...
     */
    public editarEstudiante(java.awt.Frame parent, boolean modal, SistemaUsuarios sistema, String cambio) {
        super(parent, modal);
    ...
    private void confirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarActionPerformed
        ...
        sistema.editarEstudiante(IdOriginal, id, nombre, password, carne, carrera, correo);
        dispose();
